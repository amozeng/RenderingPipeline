...
//}
//
//void ShaderTextureLight::SendMaterial(const Matrix& world, const Vect& amb, const Vect& dif, const Vect& sp)
//{
//	Data_WorldAndMaterial wm;
//	wm.Mat.Ambient = amb;
//	wm.Mat.Diffuse = dif;
...
void ShaderTextureLight::SendFogParameters(float fogStart, float fogRange, const Vect& fogColor)
{
	Data_Fog fog;
